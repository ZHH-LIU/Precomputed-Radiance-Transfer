...
inline void Shader::setVec4(const std::string& name, float v1, float v2, float v3, float v4) const
{
...
inline void Shader::setVec3(const std::string& name, const glm::vec3& vec3) const
{
    glUniform3f(glGetUniformLocation(ID, name.c_str()), vec3.x, vec3.y, vec3.z);
}
inline void Shader::setMat4(const std::string& name, const float* transform) const
{       
